...
set Plantilla="c:\scripts\CCN-STIC-599B19 ENS categoria alta - DL\CCN-STIC-599B19 ENS clientes independientes categoria alta - DL.inf"

@echo.
@echo Configurando plantilla de seguridad...
@echo on
secedit /configure /quiet /db "c:\scripts\plantilla_windows.sdb" /cfg %Plantilla% /overwrite /log "c:\scripts\CCN-STIC-599B19 ENS categoria alta - DL\plantilla_windows.log"
@echo off
