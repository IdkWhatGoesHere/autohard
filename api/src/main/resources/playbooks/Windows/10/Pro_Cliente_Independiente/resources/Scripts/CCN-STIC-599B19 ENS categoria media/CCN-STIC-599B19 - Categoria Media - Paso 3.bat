...
set Plantilla="c:\scripts\CCN-STIC-599B19 ENS categoria media\CCN-STIC-599B19 ENS Servicios categoria media.inf"

@echo.
@echo Configurando servicios de Windows...
@echo on
secedit /configure /quiet /db "c:\scripts\servicios_windows.sdb" /cfg %Plantilla% /overwrite /log "c:\scripts\CCN-STIC-599B19 ENS categoria media\servicios_windows.log"
@echo off
