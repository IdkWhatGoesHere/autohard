...
set Plantilla="c:\scripts\CCN-STIC-599B19 ENS categoria basica\CCN-STIC-599B19 ENS Servicios categoria basica.inf"

@echo.
@echo Configurando servicios de Windows...
@echo on
secedit /configure /quiet /db "c:\scripts\servicios_windows.sdb" /cfg %Plantilla% /overwrite /log "c:\scripts\CCN-STIC-599B19 ENS categoria basica\servicios_windows.log"
@echo off
